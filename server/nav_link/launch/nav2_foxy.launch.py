...
def generate_launch_description():
	map_dir = LaunchConfiguration(
		'map',
		default = PathJoinSubstitution([FindPackageShare('nav_link'),'maps','home1.yaml'])
		)
	
	param_dir = LaunchConfiguration(
		'params_file',
		default = PathJoinSubstitution([FindPackageShare('nav_link'),'config','nav2_foxy2_params.yaml'])
	)
